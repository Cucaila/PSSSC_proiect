...
using PSSC_Proiect.Models.ServiceBus;
using System.Linq;

namespace PSSC_Proiect.Events.ServiceBus
{
    public class ServiceBusTopicEventListener : IEventListener
    {
        private const string TopicName = "PsscDB";
        private const string SubscriptionName = "ac55ddc4-e61a-4d99-a4b5-a98de0b8d08f";
